    ...
    <main class="tm-main">
        ...
        <div class="row tm-row">
            <article class="col-12 col-md-6 tm-post">
                ...
                <p class="tm-pt-30">
                    Dunia Design tidak sedekar tentang keindaham.<br>
                    Dalam desain keindahan memanglah penting<br>
                    Namun bagaimana kepuasan pengguna lebih utama
                </p>
                <div class="d-flex justify-content-between tm-pt-45">
                    <span class="tm-color-primary">Evest. Events</span>
                    <span class="tm-color-primary">July 24, 2021</span>
                </div>
                <hr>
            ...
            <article class="col-12 col-md-6 tm-post">
                ...
                <p class="tm-pt-30">
                    ...
                    Objek dalam desain harus terlihat nyata dan menarik
                </p>
                <div class="d-flex justify-content-between tm-pt-45">
