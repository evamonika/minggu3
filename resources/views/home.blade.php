      ...
      <div class="row tm-row">
        ...
        <article class="col-12 col-md-6 tm-post">
          ...
          <p class="tm-pt-30">
            ...
            Objek dalam desain tidak harus selalu indah namun dapat membuat pelihat nyaman dan tertarik
          </p>
          <div class="d-flex justify-content-between tm-pt-45">
        ...
        <article class="col-12 col-md-6 tm-post">
          ...
          <p class="tm-pt-30">
            ...
            <span class="tm-color-primary">Text #999 Line #0CCC Next #0C0C Prev #F0F0F0</span>
          </p>
          <div class="d-flex justify-content-between tm-pt-45">
